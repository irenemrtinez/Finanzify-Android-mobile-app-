...
public class CategoriasPagosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_categorias_pagos);
        ...
        textViewIngresos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CategoriasPagosActivity.this, CategoriasIngresosActivity.class);
        ...
        buttonVolver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CategoriasPagosActivity.this, AjustesActivity.class);
                startActivity(intent);
            }
        });
        // fin
        ...
        buttonanadir.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CategoriasPagosActivity.this, CrearCategoriasActivity.class);
                startActivity(intent);
            }
        });
        // fin boton añadir
        ...
        if (user != null) {
            ...
            categoriasRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onCancelled(DatabaseError databaseError) {
                    Toast.makeText(CategoriasPagosActivity.this, "Error al obtener categorías: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
