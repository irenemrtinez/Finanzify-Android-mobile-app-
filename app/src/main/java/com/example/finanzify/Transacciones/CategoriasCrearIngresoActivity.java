...
public class CategoriasCrearIngresoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_categorias_crear_ingreso);
                ...
                if (user != null) {
                    ...
                    categoriasRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                ...
                                if (categoria != null && categoria.getNombre().equals(categoriaSeleccionada.getNombre())) {
                                    // Configurar el Intent para pasar los datos de vuelta a la actividad de creación de "ingresos"
                                    if (getIntent().getStringExtra("fechaSeleccionada") != null)
                                    {
                                        String fechaSeleccionada = getIntent().getStringExtra("fechaSeleccionada");
                                        Intent intent = new Intent(CategoriasCrearIngresoActivity.this, CrearIngresoActivity.class);
                                        ...
                                        Intent intent = new Intent(CategoriasCrearIngresoActivity.this, IngresoRecurrenteActivity.class);
                                        intent.putExtra("categoriaSeleccionada", categoria.getNombre());
                                        intent.putExtra("numeroCategoria", snapshot.getKey()); // Aquí obtenemos la clave de la categoría
                        ...
                        public void onCancelled(@NonNull DatabaseError databaseError) {
                            Toast.makeText(CategoriasCrearIngresoActivity.this, "Error al obtener categorías: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
        ...
        textViewIngresos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CategoriasCrearIngresoActivity.this, CategoriasIngresosActivity.class);
