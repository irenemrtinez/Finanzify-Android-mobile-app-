...
public class CrearPagoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra("fechaSeleccionada")) {
            // La actividad fue iniciada desde CategoriasCrearPagoActivity
        ...
        categoria.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CrearPagoActivity.this,CategoriasCrearPagoActivity.class);
        ...
        textViewIngresos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CrearPagoActivity.this, CrearIngresoActivity.class);
        ...
        Recurrente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String mensaje = mensajeEditText.getText().toString();
                // Crear un Intent para abrir la nueva actividad
                Intent intent = new Intent(CrearPagoActivity.this, PagoRecurrenteActivity.class);
                // Iniciar la nueva actividad
                        ...
                        categoriasRef.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (categoria != null) {
                                    ...
                                    Toast.makeText(CrearPagoActivity.this, "Error: No se pudo recuperar la categoría seleccionada", Toast.LENGTH_SHORT).show();
                                }
                            }

                            @Override
                            public void onCancelled(@NonNull DatabaseError databaseError) {
                                Toast.makeText(CrearPagoActivity.this, "Error al obtener la categoría: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                }
        ...
        transaccionesRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (esFechaAnteriorOIgual(fecha, fechaActual)) {
                    actualizarBalance(cantidad, nuevaClave);
                    Transaccion transaccion = new Transaccion(fecha, cantidad, categoria, mensaje, "pago", true);
                    ...
                    Transaccion transaccion = new Transaccion(fecha, cantidad, categoria, mensaje, "pago", false);
                    transaccionRef.setValue(transaccion); // Guardamos los datos de la nueva transacción en la base de datos
                }

                // Mostramos un mensaje de éxito
                Toast.makeText(CrearPagoActivity.this, "Transacción creada exitosamente", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                // Manejar errores si los hay
                Toast.makeText(CrearPagoActivity.this, "Error al obtener el número de transacciones: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void actualizarBalance(double cantidad, String clave) {
        // Obtener el UID del usuario actual
        FirebaseAuth mAuth = FirebaseAuth.getInstance();
        String currentUserUID = mAuth.getCurrentUser().getUid();
        ...
        balanceRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                // Manejar errores si los hay
                Toast.makeText(CrearPagoActivity.this, "Error al obtener el balance: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
